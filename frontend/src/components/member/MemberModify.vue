        ...
        <div class="input-form col-md-12 mx-auto">
            ...
            <form class="validation-form" novalidate>
                <div class="row"> 
                    ...
                    <router-link :to="{ name: 'MemberView', params: { userId: userid } }" class="link"><button class="btn btn-primary btn-lg btn-block"  type="button">회원정보보기</button></router-link></div>
                    </div>
...
export default {
    ...
    created() {
    http.get(`vue/api/vueuser/${this.$route.params.userId}`).then(({ data }) => {
